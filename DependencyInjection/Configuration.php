                ...
                ->arrayNode('paths')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->arrayNode('rules')
                                ->defaultValue([])
                                ->info('Rate limit rules')
                                ->arrayPrototype()
                                    ->children()
                                        ->integerNode('min')->min(0)->max(99999999)->end()
                                        ->integerNode('max')->min(0)->max(99999999)->end()
                                        ->integerNode('increment')->isRequired()->defaultValue(0)->min(0)->end()
                                    ->end()
                                ->end()
                                ->requiresAtLeastOneElement()
                            ->end()
